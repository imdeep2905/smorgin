  ...
  return (
    <Link
      bg={useColorModeValue(
        location.pathname == "/" + children.toLowerCase() ? "gray.50" : null,
        location.pathname == "/" + children.toLowerCase() ? "gray.700" : null
      )}
      px={2}
      py={1}
      rounded={"md"}
      ...
      href={
        location.pathname == "/" + children.toLowerCase()
          ? "#"
...
const Navbar = () => {
  const {
    isOpen: isOpenForNavbar,
    onOpen: onOpenForNavbar,
    onClose: onCloseForNavbar,
  } = useDisclosure();
  const {
    isOpen: isOpenForModal,
    onOpen: onOpenForModal,
        ...
        <Flex h={16} alignItems={"center"} justifyContent={"space-between"}>
          ...
          <Flex alignItems={"center"}>
            ...
            <Menu>
              ...
              <MenuList>
                <MenuItem onClick={onOpenForModal}>
                  <SiBinance />
